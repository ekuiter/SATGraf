...
public class ForceFactory {
    ...
    public abstract class AttractionForce {
        ...
        public abstract void apply(Node n1, ForceAtlas2LayoutData n1Layout, Node n2, ForceAtlas2LayoutData n2Layout, double e); // Model for node-node attraction (e is for edge weight if needed)
    }

    public abstract class RepulsionForce {

        public abstract void apply(Node n1, ForceAtlas2LayoutData n1Layout, Node n2, ForceAtlas2LayoutData n2Layout);           // Model for node-node repulsion

        public abstract void apply(Node n, ForceAtlas2LayoutData nLayout, Region r);           // Model for Barnes Hut approximation

        public abstract void apply(Node n, ForceAtlas2LayoutData nLayout, double g);           // Model for gravitation (anti-repulsion)
    }
    ...
    private class linRepulsion extends RepulsionForce {
        ...
        @Override
        public void apply(Node n1, ForceAtlas2LayoutData n1Layout, Node n2, ForceAtlas2LayoutData n2Layout) {
        ...
        @Override
        public void apply(Node n, ForceAtlas2LayoutData nLayout, Region r) {
            //ForceAtlas2LayoutData nLayout = n.getLayoutData();

            // Get the distance
            double xDist = nLayout.x - r.getMassCenterX();
            double yDist = nLayout.y - r.getMassCenterY();
            double distance = (float) Math.sqrt(xDist * xDist + yDist * yDist);
        ...
        @Override
        public void apply(Node n, ForceAtlas2LayoutData nLayout, double g) {
            //ForceAtlas2LayoutData nLayout = n.getLayoutData();

            // Get the distance
            double xDist = nLayout.x;
            double yDist = nLayout.y;
            double distance = (float) Math.sqrt(xDist * xDist + yDist * yDist);
    ...
    private class linAttraction extends AttractionForce {
        ...
        @Override
        public void apply(Node n1, ForceAtlas2LayoutData n1Layout, Node n2, ForceAtlas2LayoutData n2Layout, double e) {
            //ForceAtlas2LayoutData n1Layout = n1.getLayoutData();
            //ForceAtlas2LayoutData n2Layout = n2.getLayoutData();
