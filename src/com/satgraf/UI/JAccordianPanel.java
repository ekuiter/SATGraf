 ...
 */
public class JAccordianPanel extends JPanel implements ActionListener
{
  /**
  ...
  public void removeBars(){
    ...
    visibleBar = -1;
    bars.addAll(this.bars.keySet());
    for(int i = 0; i < bars.size(); i++){
      removeBar(bars.get(i));
    }
  }
  ...
  public static void main( String[] args )
  {
    ...
    JAccordianPanel outlookBar = new JAccordianPanel();
